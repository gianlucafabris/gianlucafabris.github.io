...
export default function Home({ typedContainer="typed" }){
    ...
    return <>
        ...
        <Row>
            <Col md={12} className={"blur"}>
                <p>For now you can visit the following pages (still WIP) <Link to="/printables">Printables</Link>, <Link to="/thesis">Thesis</Link>, <Link to="/solarsystem">Solar System</Link>, and <Link to="https://gianlucafabris.github.io/MultimaterialToSwapGCode/" target="_blank">MultimaterialToSwapGCode</Link>.</p>
            </Col>
        </Row>
    </>;
};
