...
import { GizmoHelper, GizmoViewport, useHelper, OrbitControls, OrthographicCamera, Float } from '@react-three/drei';
...
function Experience(){
    ...
    return <>
        ...
        {useDebugFlag() ? <OrbitControls makeDefault/> : null}
        ...
        {useDebugFlag() && config_debug.show_3Ddebug && config_debug.show_pivotcontrols ? <>
        ...
        {useDebugFlag() && config_debug.show_3Ddebug && config_debug.show_pivotcontrols ? <DebugPivot>
