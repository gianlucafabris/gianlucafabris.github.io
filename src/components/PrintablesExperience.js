...
import { PivotControls } from '../components/Utils/pivotControls/index.tsx';
import { getDebug, addDebug } from '../components/Utils/Debug.js';

export default function PrintablesExperience(){
    const printablesExperienceConfig = {
        ambientLight: {
            intensity: 1.0,
            color: "#1c1e21"
        },
    ...
    let config = addDebug("3d experience", {
        ambientLight: folder({
            ambientLight_intensity: {
                value: printablesExperienceConfig.ambientLight.intensity,
                min: 0,
                max: 10,
                step: 0.1,
                label: "intensity"
            ...
            ambientLight_color: {
                value: printablesExperienceConfig.ambientLight.color,
                label: "color"
            }
        }, {collapsed: true}),
        pointLight: folder({
            pointLight_position: {
                value: printablesExperienceConfig.pointLight.position,
                min: -10,
                max: 10,
                step: 0.1,
                label: "position"
            ...
            pointLight_intensity: {
                value: printablesExperienceConfig.pointLight.intensity,
                min: 0,
                max: 10,
                step: 0.1,
                label: "intensity"
            ...
            pointLight_color: {
                value: printablesExperienceConfig.pointLight.color,
                label: "color"
            }
        }, {collapsed: true}),
        printables: folder({
            printables_float: folder({
                printables_float_speed: {
                    value: printablesExperienceConfig.printables.float.speed,
                    min: 0,
                    max: 10,
                    step: 0.1,
                    label: "speed"
                ...
                printables_float_rotationIntensity: {
                    value: printablesExperienceConfig.printables.float.rotationIntensity,
                    min: 0,
                    max: 10,
                    step: 0.1,
                ...
                printables_float_floatIntensity: {
                    value: printablesExperienceConfig.printables.float.floatIntensity,
                    min: 0,
                    max: 10,
                    step: 0.1,
                ...
                printables_float_floatingRange: {
                    value: printablesExperienceConfig.printables.float.floatingRange,
                    min: -10,
                    max: 10,
                    step: 0.1,
                    label: "floatingRange"
            ...
            printables_scale: {
                value: printablesExperienceConfig.printables.scale,
                min: 0,
                max: 10,
                step: 0.1,
                label: "scale"
            ...
            printables_position: {
                value: printablesExperienceConfig.printables.position,
                min: -10,
                max: 10,
                step: 0.1,
                label: "position"
            ...
            printables_rotation: {
                value: printablesExperienceConfig.printables.rotation,
                min: 0,
                max: 2*Math.PI,
                step: 0.1,
                label: "rotation"
            ...
            printables_color: {
                value: printablesExperienceConfig.printables.color,
                label: "color"
            }
        }, {collapsed: true})
    });
    if(config == null){
        config = {...printablesExperienceConfig}
    }else{
        //ouput fix
        config.ambientLight = {}
