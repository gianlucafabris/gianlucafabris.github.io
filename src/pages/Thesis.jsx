...
export default function Thesis(){
    ...
    return <>
        ...
        <Row>
            <Col md={12} className={"blur"}>
                <h2>Resources</h2>
                <p><Link to="https://drive.google.com/file/d/1siuiS3j4CdlGHEfWTbJEy1xZIaBR9Jmx/view?usp=sharing" target="_blank">thesis</Link></p>
                <p><Link to="https://drive.google.com/file/d/1mmctSXk7NwZpZN3yfJdmJLWTZgccr9b0/view?usp=sharing" target="_blank">presentation</Link></p>
                <p><Link to="https://github.com/gianlucafabris/BeamNGpy---Road-test" target="_blank">Github - BeamNGpy - Road test</Link></p>
                <p><Link to="https://github.com/gianlucafabris/Import-OSM-custom" target="_blank">Github - Import OSM custom</Link></p>
                <p><Link to="https://github.com/gianlucafabris/Import-OSM-custom---analysis-BeamNG-and-Hexagon" target="_blank">Github - Import OSM custom - analysis BeamNG and Hexagon</Link></p>
            </Col>
        </Row>
    </>;
};
