                ...
                <bootstrap.Col md={12} className="blur">
                    <div className="footer flex">
                        ...
                        <div className="social">
                            <a href="/#/home" target="_blank"><i className="bi bi-globe2"></i></a>
                            <a href="https://www.linkedin.com/in/gianluca-fabris-2001/" target="_blank"><i className="bi bi-linkedin"></i></a>
                            <a href="https://github.com/gianlucafabris" target="_blank"><i className="bi bi-github"></i></a>
                            <a href="https://www.printables.com/@gianlucafabris2001" target="_blank">
